...
namespace intersectionsplitter {
    ...
    const Point scanLineVec(1.f, 0.f);

    bool zeroDist(float dist)
    {
        return std::fabs(dist) < 0.1;
    }
    ...
    int intersection(const LineSegment& a, const LineSegment& b, Point& outIntersectionPoint, float& outDistanceFromAStart, float& outDistanceFromBStart, float maxDistance)
    {
    ...
    int intersection(const LineSegmentPtr a, const LineSegmentPtr b, Point& outIntersectionPoint, float& outDistanceFromAStart, float& outDistanceFromBStart, float maxDistance)
    {
