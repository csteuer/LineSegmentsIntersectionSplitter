...
namespace intersectionsplitter {
     ...
     * @param the maximum distance between the intersection point and the nearest endpoint of both fragments
     ...
     */
    int intersection(const LineSegment& a, const LineSegment& b, Point& outIntersectionPoint, float& outDistanceFromAStart,  float& outDistanceFromBStart, float maxDistance = 0.f);
    int intersection(const LineSegmentPtr a, const LineSegmentPtr b, Point& outIntersectionPoint, float& outDistanceFromAStart,  float& outDistanceFromBStart, float maxDistance = 0.f);
