...
namespace intersectionsplitter {
     ...
     */
    INTERSECTIONSPLITTER_API std::vector<LineSegmentPtr> splitLineSegmentsAtIntersections(const std::vector<LineSegmentPtr>& segments, float extendedIntersectionDistance = 0.f);
